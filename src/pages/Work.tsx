...
const aanpak = [
  {
    ...
    title: "Jouw verhaal",
    description: "Jij vertelt wat je voor ogen hebt. Ik denk met je mee en probeer snel te snappen waar het echt om draait. Een uitgebreide briefing mag, maar een krabbel op papier vind ik even goed.",
  },
  {
